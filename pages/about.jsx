...
import aboutImage from "../public/pro2.jpg";
        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] md:text-base md:text-md lg:text-lg xl:text-xl mx-auto font-light dark:text-white text-gray-900 ">
            ...
            <p className="">
              ...
              <span className="text-red-600 font-bold">Gmail</span>{" "}
              <a
                onClick={() =>
                  navigator.clipboard.writeText("neodev0725@gmail.com")
                }
                ...
                href="mailto:neodev0725@gmail.com"
              >
                {" "}
                neodev0725@gmail.com
              </a>{" "}
              or <span className="text-blue-700 font-bold">Facebook</span>{" "}
              <a
                href="https://www.facebook.com/kenobbo"
