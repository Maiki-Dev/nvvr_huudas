        ...
        <div className="lg:h-screen 2xl:h-max max-w-[90rem] mx-auto">
          ...
          <div className="mt-12 m:text-xl md:text-xl lg:text-2xl">
            <p className="font-light sm:leading-6 md:leading-6 lg:leading-8">
              ...
              <span className="font-medium select-none animate-text bg-gradient-to-br from-[#ff0000] dark:from-[#ff0000] via-[#0000ff] dark:via-[#1500ff] dark:text-black  text-border2 to-[#0b5394] dark:to-[#ff3c00] rounded px-2 py-[0.05rem] ">
                MONGOLIAN
              </span>{" "}
